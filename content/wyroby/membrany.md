...
**System 3+ dla EPD**: Producenci membran PVC-P dążący do udziału w przetargach z kryteriami zielonymi (GPP – Green Public Procurement) mogą skorzystać z Systemu 3+ do walidacji swojej Deklaracji Środowiskowej Wyrobu (EPD). Jednostka notyfikowana waliduje dane środowiskowe i wydaje raport walidacyjny – nie certyfikat. Walidacja wzmacnia pozycję rynkową w zamówieniach publicznych, gdzie GWP staje się kryterium wyboru.
