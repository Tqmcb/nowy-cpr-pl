...
- **System AVS 3** – w modelu docelowym będzie dotyczył klejów ulepszonych (C2, D2), reaktywnych (R1/R2), odkształcalnych (S1/S2) oraz do zastosowań zewnętrznych i stref mokrych. Istotny będzie udział notyfikowanego laboratorium technicznego (NTL) w badaniu typu. Do czasu publikacji odpowiedniej hTS producenci tej rodziny zasadniczo działają jednak według obowiązujących hEN, AVCP i DoP; nowy układ dokumentacji i oznakowania CE będzie wynikał z przyszłej specyfikacji.
