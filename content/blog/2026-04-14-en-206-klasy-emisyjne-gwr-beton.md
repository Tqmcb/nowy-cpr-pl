---
title: "EN 206-1:2026 — nowe klasy emisyjne GWR dla betonu. Co musi wiedzieć producent?"
reviewed: "2026-04-14"
date: "2026-04-14"
...
Norma EN 206-1:2026, której publikacja przez CEN nastąpiła w pierwszym kwartale 2026 roku, wprowadza w §5.4 zupełnie nowy element: **obowiązkową klasyfikację betonu według potencjału globalnego ocieplenia** — tzw. **klasy GWR (Global Warming Rating)**.

To nie jest kolejny opcjonalny załącznik informacyjny. Klasy GWR stają się integralną częścią specyfikacji betonu — obok klasy wytrzymałości, klasy ekspozycji i konsystencji. Każda receptura betonu towarowego będzie musiała mieć przypisaną klasę GWR.

Dla właścicieli wytwórni betonu to zmiana porównywalna z wprowadzeniem klas ekspozycji w EN 206:2013. Wówczas producenci musieli przeliczyć receptury pod kątem trwałości. Teraz muszą je przeliczyć pod kątem śladu węglowego.
...
Klasy GWR od 1 do 6 odpowiadają progom redukcji emisji względem tej wartości referencyjnej:

| Klasa GWR | Redukcja CO2 vs CEM I | Opis |
|---|---|---|
| **GWR 1** | < 15% | Beton konwencjonalny, wysoki udział CEM I |
| **GWR 2** | 15–30% | Umiarkowana optymalizacja spoiwa |
| **GWR 3** | 30–45% | Znacząca redukcja — cementy wieloskładnikowe |
| **GWR 4** | 45–55% | Zaawansowana optymalizacja receptury |
| **GWR 5** | 55–65% | Beton niskoemisynjy — np. 138 kg CO2/m3 dla C30/37 |
| **GWR 6** | > 65% | Beton ultra-niskoemisynjy, maksymalne wykorzystanie SCM |

Weźmy przykład z kalkulatora: beton C30/37 o emisji **138 kg CO2/m3** to redukcja **56% względem wartości referencyjnej 312 kg CO2/m3**. Taki beton klasyfikuje się jako **GWR 5** — a więc jest już w czołówce pod względem efektywności emisyjnej.

---

## Skąd wzięły się progi? Powiązanie z GCCA

Klasy GWR w EN 206-1:2026 nie powstały w próżni. Bazują na systematyce zaproponowanej przez **GCCA (Global Cement and Concrete Association)**, największą światową organizację branży cementowo-betonowej.

GCCA opracowała system pasm emisyjnych oznaczonych literami od **AA** (najniższa emisja) do **G** (najwyższa), opublikowany w ramach ich programu dekarbonizacji „Getting the Numbers Right" (GNR). Pasma GCCA są globalne — obejmują dane z ponad 900 producentów w kilkudziesięciu krajach.

Klasy GWR w EN 206 są europejską adaptacją tego systemu: progi zostały dostosowane do europejskiego miksu cementów i typowych receptur stosowanych w UE. Kluczowa różnica polega na tym, że system GCCA jest dobrowolny i raportowy, natomiast **klasy GWR w EN 206 są normatywne** — producent musi je deklarować.

Relacja orientacyjna między systemami:

| GCCA Band | Przybliżony odpowiednik GWR |
|---|---|
| AA – A | GWR 6 |
| B | GWR 5 |
| C | GWR 4 |
...
## Powiązanie z CPR 2024/3110 — GWR w Deklaracji Właściwości Użytkowych i Środowiskowych
...
1. **Producent betonu musi znać klasę GWR** każdej swojej receptury, aby poprawnie wypełnić DoPC.
2. **Klasa GWR musi być oparta na wiarygodnych danych** — nie na szacunkach czy deklaracjach własnych bez weryfikacji.
3. **Dane źródłowe do obliczenia GWR** pochodzą z analizy LCA (Life Cycle Assessment) przeprowadzonej zgodnie z normami EN 15804+A2 i EN 16757:2022.

Innymi słowy: klasa GWR to „skrót" — łatwy do odczytania wynik tego, co w tle jest pełną analizą cyklu życia betonu.
...
Niekoniecznie — ale docelowo tak. Na etapie przejściowym EN 206-1:2026 dopuszcza korzystanie z:
...
EPD indywidualne daje wyższą precyzję i często lepszą klasę GWR, bo uwzględnia faktyczny miks spoiwa, lokalne kruszywo i efektywność energetyczną zakładu. EPD sektorowe jest bezpieczniejsze (konserwatywne wartości), ale może zaniżać rzeczywistą wydajność emisyjną producenta.
...
Nie czekaj na ostatni moment. Klasy GWR wchodzą w specyfikację EN 206, a harmonogram przejściowy nie jest długi. Oto konkretne kroki:
...
- Receptura C30/37, emisja 138 kg CO2/m3 → redukcja 56% → **GWR 5**
...
- stanowi fundament pod DoPC wymagane przez CPR 2024/3110,
...
- przypisywania klasy GWR do dokumentów dostawy i specyfikacji,
...
Ci, którzy będą czekać do ostatniej chwili, będą musieli to wszystko nadrobić pod presją czasu — i prawdopodobnie z wyższymi kosztami konsultingowymi i certyfikacyjnymi.
...
| Pytanie | Odpowiedź |
|---|---|
| Co to jest GWR? | Klasyfikacja emisji CO2 betonu w 6 klasach (GWR 1–6) |
...
| Co oznacza GWR 5? | Redukcja 55–65% vs CEM I (np. 138 kg CO2/m3 dla C30/37) |
| Jak się łączy z CPR? | GWR jest parametrem sekcji środowiskowej DoPC (CPR 2024/3110) |
| Skąd dane do GWR? | Z EPD sporządzonego wg EN 15804+A2 i EN 16757:2022 |
| Kto weryfikuje dane? | NTL w systemie AVS 3+ lub weryfikator w programie EPD |
