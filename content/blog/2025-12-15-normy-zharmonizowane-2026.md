...
Komisja Europejska pracuje nad kolejnymi aktualizacjami. W najbliższych latach należy spodziewać się zmian w normach dla:

- Klejów budowlanych (EN 12004)
- Wyrobów hydroizolacyjnych (EN 13707)
- Systemów ociepleń ETICS (EN 13499/13500)

## Jak śledzić zmiany?

1. **Dziennik Urzędowy UE** – oficjalne publikacje norm zharmonizowanych
2. **CEN/CENELEC** – strony komitetów normalizacyjnych
3. **PKN** – Polski Komitet Normalizacyjny (pkn.pl)
4. **NowyCPR.pl** – bieżące informacje i interpretacje

## Konsekwencje braku aktualizacji

Producenci korzystający z nieaktualnych norm ryzykują:
