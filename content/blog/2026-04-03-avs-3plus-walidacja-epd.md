...
JN sprawdza, czy granice systemu zadeklarowane w EPD są zgodne z normą EN 15804+A2 oraz ewentualnymi PCR (Product Category Rules) dla danej grupy wyrobów. Obejmuje to weryfikację, które moduły cyklu życia (A1–A5, B1–B7, C1–C4, D) zostały uwzględnione i czy jest to zgodne z wymaganiami.
...
Efektem pracy JN w systemie 3+ jest **Raport walidacyjny** (ang. *Validation Report* lub *Verification Statement*). Dokument ten potwierdza, że metodologia i dane leżące u podstaw EPD zostały niezależnie zweryfikowane. Raport jest załączany do EPD jako dowód niezależnej weryfikacji, co podnosi wiarygodność deklaracji w oczach zamawiających, specyfikantów i nabywców.
...
System 3+ dotyczy wyłącznie walidacji danych środowiskowych. Orientacyjne koszty walidacji EPD przez akredytowaną JN wynoszą w Europie od **3 000 do 15 000 EUR**, w zależności od:
...
## Kto świadczy usługę walidacji EPD w Polsce

W Polsce walidację EPD zgodną z EN 15804+A2 i wymaganiami CPR 2024 (system AVS 3+) mogą świadczyć:
...
Nie każdy producent musi natychmiast stosować system 3+ dla wszystkich swoich EPD. Warto rozważyć walidację w następujących sytuacjach:

**Przetargi publiczne i GPP** — zamawiający wymagający EPD z niezależną weryfikacją (szczególnie w projektach UE) będą preferować lub wymagać EPD opartych na systemie 3+. Zwalidowane EPD daje przewagę konkurencyjną i spełnia najwyższe standardy transparentności.
...
## AVS 3+ a przyszłość deklarowania środowiskowego w CPR

CPR 2024/3110 przewiduje stopniowe rozszerzanie zakresu obowiązkowego deklarowania właściwości środowiskowych. Komisja Europejska ma uprawnienie do wydawania aktów delegowanych nakładających obowiązek deklarowania GWP i innych wskaźników dla określonych grup wyrobów. W takiej sytuacji system 3+ przestanie być opcją — stanie się wymogiem dla producentów w objętych grupach wyrobów.

Już teraz warto traktować inwestycję w walidację EPD (system 3+) nie tylko jako odpowiedź na aktualne wymagania rynkowe, ale jako przygotowanie do regulacji, które z dużym prawdopodobieństwem wejdą w życie do 2030 roku.

## Podsumowanie

System AVS 3+ to logiczne uzupełnienie nowej architektury CPR 2024 — narzędzie precyzyjnie dostosowane do walidacji danych środowiskowych, bez zbędnego rozszerzania na certyfikację właściwości technicznych. JN w tym systemie pełni rolę niezależnego audytora metodologicznego, a jej Raport walidacyjny podnosi wartość EPD w oczach wszystkich uczestników łańcucha budowlanego. Producenci, którzy wcześnie wdrożą system 3+, zyskają wiarygodność i przewagę w segmencie rynku, który rośnie najszybciej.
