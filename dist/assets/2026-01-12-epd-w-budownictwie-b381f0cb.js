...
W **CPR 2024** wska\\u017aniki środowiskowe są obowiązkowe, ale **pełna EPD nie**. Wymagane minimum to:

✅ Obliczenie wskaźników GWP, ODP, AP, EP, POCP  
✅ Zgodność z EN 15804+A2  
✅ Weryfikacja przez niezale\\u017cną jednostkę  

Jednak **posiadanie EPD** daje przewagę konkurencyjną i ułatwia procedury!

## Etapy tworzenia EPD

### 1. Analiza LCA (2-4 tygodnie)
- Zbieranie danych inwentarzowych
- Modelowanie w oprogramowaniu (np. SimaPro, GaBi, openLCA)
- Obliczanie wskaźników

### 2. Weryfikacja (1-2 tygodnie)
- Audyt przez niezależnego weryfikatora
...
**Komercyjne**:
- SimaPro (najczęściej używane)
- GaBi (bardzo rozbudowane)
- Athena Impact Estimator

**Open Source**:
- openLCA (darmowe, polecane na start)
