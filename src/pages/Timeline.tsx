...
const TIMELINE_EVENTS: TimelineEvent[] = [
  ...
  // ── TERAZ (2025-2026) ──
  {
    ...
    sortDate: "2026-01-08",
    title: "Pełne stosowanie CPR 2024",
    description:
      "Nowe rozporządzenie stosuje się w pełni. Producenci muszą wystawiać DoP&C (Deklaracja Właściwości Użytkowych i Zgodności) zamiast starego DoP. Nowe oznakowanie CE wg Art. 20.",
    phase: "teraz",
  ...
  },
  {
    date: "8 stycznia 2026",
    sortDate: "2026-01-08",
    title: "Nowe obowiazki importerów i dystrybutorów",
    description:
      "Importerzy i dystrybutorzy muszą spełniać rozszerzone obowiązki weryfikacji dokumentacji i śledzenia łańcucha dostaw (Art. 22-23).",
    phase: "teraz",
    category: ["prawo"],
    icon: Building2,
    article: "Art. 22-23",
  },
  {
    date: "8 stycznia 2026",
    sortDate: "2026-01-08",
    title: "System AVS zastępuje systemy AVCP",
    description:
      "Nowy system Oceny i Weryfikacji Stałości Właściwości Użytkowych (AVS) z 5 poziomami: 1+, 1, 2, 3, 4. Zmienione obowiązki jednostek notyfikowanych.",
    phase: "teraz",
