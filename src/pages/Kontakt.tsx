          ...
          <div className="max-w-3xl mx-auto space-y-8 pt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 flex flex-col gap-4">
                <div className="w-10 h-10 rounded-xl bg-[oklch(55% .22 27)]/10 flex items-center justify-center">
                  <Mail className="w-5 h-5 text-[oklch(55% .22 27)]" />
                </div>
                <div>
                  <p className="text-slate-500 text-sm mb-1">E-mail</p>
                  <a
                    href="mailto:biuro@multicert.pl"
                    className="text-[oklch(20% .03 264)] font-semibold hover:text-[oklch(55% .22 27)] transition-colors"
                  >
                    biuro@multicert.pl
                  </a>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 flex flex-col gap-4">
                <div className="w-10 h-10 rounded-xl bg-[oklch(55% .22 27)]/10 flex items-center justify-center">
                  <MapPin className="w-5 h-5 text-[oklch(55% .22 27)]" />
                </div>
                <div>
            ...
            <section className="rounded-2xl border border-slate-200 bg-white shadow-sm p-8">
              <h2 className="text-xl font-bold text-[oklch(20% .03 264)] mb-4">
                Multicert Sp. z o.o.
              </h2>
            ...
            {/* Services CTA */}
            <section className="rounded-2xl border border-[oklch(55% .22 27)]/20 bg-[oklch(55% .22 27)]/5 p-8">
              <h2 className="text-xl font-bold text-[oklch(20% .03 264)] mb-4">
