            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="md:w-2/3">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#1a56a0]/10 border border-[#1a56a0]/20 mb-6">
                  ...
                  <span className="text-[#1a56a0] text-sm font-medium">Dokumentacja CPR</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button
                    variant="outline"
                    className="px-6 py-3 rounded-full border-slate-200 text-slate-700 bg-white hover:bg-slate-50 hover:border-[#1a56a0]/40"
